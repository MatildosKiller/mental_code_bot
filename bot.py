...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        'Я родился 04.09.2025 г.,\с моим создателем https://t.me/l_andrew777 вы можете принять участие в сопровождении моего кода'
    )
    await update.message.reply_text(
        '\n Также вместе с моим хоязином вы можете разрабатывать такие же полезные программы и приложения вроде меня\n'
        'Через меня Вы можете записаться  \n\t\*на занятие по информатике\n\t*программирование С,С++,С#,Python\n\t*...или совместно проводить время над вашей задачей, Ваша запись попадет в базу данных на сервере. '
    )
