...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        'Привет, бот канала Ментальный код!\n'
        'Я родился 04.09.2025 г.,\nВместе с моим создателем https://t.me/l_andrew777 вы можете принять участие в разработке и написании моего кода'
    )
    await update.message.reply_text(
        '\n Также вы можете принять участие в разработке таких же полезных программ и приложений вроде меня\n'
        'Через мою функцию Вы можете записаться  \n\t\*на занятие по информатике\n\t*программирование С,С++,С#,Python\n\t\t*...или совместно проводить время над вашей задачей, Ваша запись попадет в базу данных на сервере\n либо пишите в личку моему хоязину. '
    ) 
